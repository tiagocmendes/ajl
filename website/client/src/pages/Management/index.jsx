...
const Management = () => {
    ...
    return (
      <StyledOuterDiv>
        <StyledPasswordInput type="text"  placeholder={'Email'} onChange={(e) => handleEmailChange(e)} />
        <StyledPasswordInput type="password"  placeholder={'Password'} onChange={(e) => handlePasswordChange(e)} />
